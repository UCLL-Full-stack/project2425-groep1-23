...
async function main() {
  ...
  // Filter out invalid assignments where userId or flashcardId is undefined
  const validAssignments = assignments.filter(
    assignment => assignment.userId !== undefined && assignment.flashcardId !== undefined
  );
  ...
  const validProgresses = progresses.filter(
    progress => progress.userId !== undefined && progress.flashcardId !== undefined
  );
